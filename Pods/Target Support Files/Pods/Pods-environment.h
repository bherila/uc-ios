...
// Pushwoosh
#define COCOAPODS_POD_AVAILABLE_Pushwoosh
#define COCOAPODS_VERSION_MAJOR_Pushwoosh 2
#define COCOAPODS_VERSION_MINOR_Pushwoosh 9
#define COCOAPODS_VERSION_PATCH_Pushwoosh 4
